...
<div class="container padd-80">
    ...
    <!--today-deal-->
    <div class="container today-deal padd-80">
...
<!--            </div>-->
        ...
        <div class="Deals col-md-10">
            <div class="owl-carousel" id="Todays-Deals">
                <div class="thumbnail no-border no-padding">
                    ...
                    <div class="caption item-body">
                        <h4 class="caption-title"><a href="#">Lorem ipsum dolor sit amet, consectetur</a>
                        </h4>
                        <div class="buy-hover"><a href="#">More Details</a>
                        </div>
                    </div>
                ...
                <div class="thumbnail no-border no-padding">
                    ...
                    <div class="caption item-body">
                        <h4 class="caption-title"><a href="#">Lorem ipsum dolor sit amet, consectetur</a></h4>
                        <div class="buy-hover"><a href="#">More Details</a>
                        </div>
                    </div>
                </div>
    ...
    <!--bottom-->
    <div class="container service-sec padd-60">
